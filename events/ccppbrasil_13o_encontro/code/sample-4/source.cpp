...
//compile:
//clang++ -std=c++14 -I../include -I./cppzmq/include -I./msgpack/include -I./random_util/include -L/usr/local/Cellar/zeromq/4.2.2/lib -lzmq source.cpp -o ./bin/source.exe
